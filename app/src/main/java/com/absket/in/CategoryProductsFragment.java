...
//        CallingProductsRetrofit(sLastProductId);
    ...
    static CategoryProductsFragment init(int position) {
        CategoryProductsFragment truitonFrag = new CategoryProductsFragment();
    ...
    public  class ProductsListAdapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            try {
                ...
                holder.tv_size_price.setText("Rs. " + itemsList.get(position).getProductName());
